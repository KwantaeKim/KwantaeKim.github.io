...
We went through place-and-route (PnR) and arrived GDS file generation in the <a href="{{ site.baseurl }}{{ post[0].url }}">last post</a>,
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-12-49-13.png' style='width:70%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-12-58-46.png' style='width:90%'>

If you are using <i class="fa-brands fa-apple fa-lg"></i> Apple Silicon MacOS, install Apple Chip version like above.

<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-13-01-27.png' style='width:49%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-13-02-37.png' style='width:49%'>

If you installed it, open the <i class="fa-brands fa-docker fa-lg"></i> **Docker** app with spotlight (`⌘ + Space`).

<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-13-05-23.png' style='width:60%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-13-05-28.png' style='width:60%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-13-05-34.png' style='width:60%'>

Go through **Accept → Finish → Skip**.

<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-13-07-37.png' style='width:60%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-14-18-52.png' style='width:60%'>

Upon the complete **Pull** process, you can find a green <i class="fa-solid fa-check" style="color: #005000;"></i> check mark.

### Git

<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-14-21-51.png' style='width:50%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-14-25-39.png' style='width:50%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-14-52-09.png' style='width:50%'>

Use `mkdir` to make a directory of `open-source` and use `cd` to move to `open-source` directory.

<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-14-55-25.png' style='width:90%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-14-59-00.png' style='width:45%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-14-59-24.png' style='width:45%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-15-02-34.png' style='width:45%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-15-09-50.png' style='width:60%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-13-07-37.png' style='width:60%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-14-18-52.png' style='width:60%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-15-43-25.png' style='width:60%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-15-43-56.png' style='width:60%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-15-45-16.png' style='width:90%'>

It is quite handy with the Portable edition, as it does not require us to go through the install process.

<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-15-50-01.png' style='width:60%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-15-51-12.png' style='width:90%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-14-59-00.png' style='width:45%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-16-10-21.png' style='width:70%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-16-13-56.png' style='width:70%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-16-20-24.png' style='width:70%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-16-24-41.png' style='width:43%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-16-25-04.png' style='width:50%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-16-33-19.png' style='width:90%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-17-02-50.png' style='width:90%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-17-03-35.png' style='width:90%'>

Then you can type password, which is `abc123` by default.

<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-17-04-18.png' style='width:45%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-17-16-32.png' style='width:45%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-17-18-08.png' style='width:20%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-17-24-24.png' style='width:70%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-17-26-04.png' style='width:70%'>
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-17-26-27.png' style='width:70%'>
...
<img src='{{ site.base_url }}{{ site.image_dir }}/blog/2024-05-28-17-29-06.png' style='width:70%'>
